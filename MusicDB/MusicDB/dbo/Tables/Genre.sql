...
(
    ...
    , [CreatedUtc]          DATETIME            NOT NULL        CONSTRAINT [DF_Genre_CreatedUtc]    DEFAULT (GETUTCDATE())
    , [CreatedBy]           NVARCHAR(255)       NOT NULL        CONSTRAINT [DF_Genre_CreatedBy]     DEFAULT (SUSER_SNAME())
