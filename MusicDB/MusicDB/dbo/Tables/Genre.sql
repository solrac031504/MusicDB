CREATE TABLE [dbo].[Genre] (
    ...
    [CreatedUtc]  DATETIME        CONSTRAINT [DF_Genre_CreatedUtc] DEFAULT (getutcdate()) NOT NULL,
    [CreatedBy]   NVARCHAR (255)  CONSTRAINT [DF_Genre_CreatedBy] DEFAULT (suser_sname()) NOT NULL,
