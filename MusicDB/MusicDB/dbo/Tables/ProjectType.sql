...
(
    ...
    , [CreatedUtc]            DATETIME            NOT NULL        CONSTRAINT [DF_ProjectType_CreatedUtc]  DEFAULT (GETUTCDATE())
    , [CreatedBy]             NVARCHAR(255)       NOT NULL        CONSTRAINT [DF_ProjectType_CreatedBy]   DEFAULT (SUSER_SNAME())
