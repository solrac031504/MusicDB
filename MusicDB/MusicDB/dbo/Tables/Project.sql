...
(
    ...
    , CreatedUtc            DATETIME            NOT NULL        CONSTRAINT [DF_Project_CreatedUtc]  DEFAULT (GETUTCDATE())
    , CreatedBy             NVARCHAR(255)       NOT NULL        CONSTRAINT [DF_Project_CreatedBy]   DEFAULT (SUSER_SNAME())
