CREATE TABLE [dbo].[ProducerGroup] (
    ...
    [CreatedUtc]        DATETIME       CONSTRAINT [DF_ProducerGroup_CreatedUtc] DEFAULT (getutcdate()) NOT NULL,
    [CreatedBy]         NVARCHAR (255) CONSTRAINT [DF_ProducerGroup_CreatedBy] DEFAULT (suser_sname()) NOT NULL,
    [ModifiedUtc]       DATETIME       NULL,
    [ModifiedBy]        NVARCHAR (255) NULL,
    CONSTRAINT [PK_ProducerGroup] PRIMARY KEY CLUSTERED ([ProducerGroupId] ASC),
    CONSTRAINT [FK_ProducerGroup_ProducerId] FOREIGN KEY ([ProducerId]) REFERENCES [dbo].[Producer] ([ProducerId])
);
