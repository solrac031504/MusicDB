...
(
    ...
    , [CreatedUtc]          DATETIME            NOT NULL        CONSTRAINT [DF_Artist_CreatedUtc]   DEFAULT (GETUTCDATE())
    , [CreatedBy]           NVARCHAR(255)       NOT NULL        CONSTRAINT [DF_Artist_CreatedBy]    DEFAULT (SUSER_SNAME())
