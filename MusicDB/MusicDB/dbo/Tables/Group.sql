...
(
    ...
    , [CreatedUtc]            DATETIME            NOT NULL        CONSTRAINT [DF_Group_CreatedUtc]    DEFAULT (GETUTCDATE())
    , [CreatedBy]             NVARCHAR(255)       NOT NULL        CONSTRAINT [DF_Group_CreatedBy]     DEFAULT (SUSER_SNAME())
