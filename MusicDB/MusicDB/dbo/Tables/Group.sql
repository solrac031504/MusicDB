CREATE TABLE [dbo].[Group] (
    ...
    [CreatedUtc]  DATETIME       CONSTRAINT [DF_Group_CreatedUtc] DEFAULT (getutcdate()) NOT NULL,
    [CreatedBy]   NVARCHAR (255) CONSTRAINT [DF_Group_CreatedBy] DEFAULT (suser_sname()) NOT NULL,
    [ModifiedUtc] DATETIME       NULL,
    [ModifiedBY]  NVARCHAR (255) NULL,
    CONSTRAINT [PK_Group] PRIMARY KEY CLUSTERED ([GroupId] ASC),
    CONSTRAINT [FK_Group_ArtistId] FOREIGN KEY ([ArtistId]) REFERENCES [dbo].[Artist] ([ArtistId])
);
