...
(
    ...
    , [CreatedUtc]            DATETIME            NOT NULL        CONSTRAINT [DF_Producer_CreatedUtc] DEFAULT (GETUTCDATE())
    , [CreatedBy]             NVARCHAR(255)       NOT NULL        CONSTRAINT [DF_Producer_CreatedBy] DEFAULT (SUSER_SNAME())
