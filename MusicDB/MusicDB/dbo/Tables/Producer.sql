CREATE TABLE [dbo].[Producer] (
    ...
    [CreatedUtc]   DATETIME       CONSTRAINT [DF_Producer_CreatedUtc] DEFAULT (getutcdate()) NOT NULL,
    [CreatedBy]    NVARCHAR (255) CONSTRAINT [DF_Producer_CreatedBy] DEFAULT (suser_sname()) NOT NULL,
