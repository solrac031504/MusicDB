CREATE TABLE [dbo].[StreamingService] (
    ...
    [CreatedUtc]  DATETIME       CONSTRAINT [DF_StreamingService_CreatedUtc] DEFAULT (getutcdate()) NOT NULL,
    [CreatedBy]   NVARCHAR (255) CONSTRAINT [DF_StreamingService_CreatedBy] DEFAULT (suser_sname()) NULL,
